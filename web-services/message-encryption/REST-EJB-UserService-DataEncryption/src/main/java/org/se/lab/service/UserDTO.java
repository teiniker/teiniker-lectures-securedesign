...
{    
	...
	public UserDTO(User u)
	{
		this(
		        u.getId(), 
		        MessageEncryption.encryptToString(u.getUsername()), 
		        MessageEncryption.encryptToString(u.getPassword()));
	}
	...
	public User toUser()
	{
		return new User(
		        getId(), 
		        MessageEncryption.decryptToString(getUsername()), 
		        MessageEncryption.decryptToString(getPassword()));
	}
