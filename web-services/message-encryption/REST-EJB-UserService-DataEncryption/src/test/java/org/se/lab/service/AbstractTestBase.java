...
public abstract class AbstractTestBase
{
    ...
    public void setup() throws IOException
    {
    	...
    	// Cipher settings
    	String keyProperty = properties.getProperty("encryption.key");
        String ivProperty = properties.getProperty("encryption.iv");
        MessageEncryption.init(keyProperty, ivProperty);
